...
globalkeys = mytable.join(
	...
	awful.key({ altkey }, "x", function()
		os.execute(string.format("rofi -sort -sorting-method fzf -show %s -theme %s", "run", "Monokai"))
	end, { description = "show rofi", group = "launcher" }),
	awful.key({ altkey }, "Tab", function()
		os.execute(string.format("rofi -sort -sorting-method fzf -show %s -theme %s", "window", "Monokai"))
	end, { description = "show rofi", group = "launcher" }),
	-- Prompt
